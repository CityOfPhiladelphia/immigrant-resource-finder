export default {
  ...
  languages: {
    ...
    translationServices: "Interpretação por telefone disponível em outros idiomas",
    'telephonic interpretation available': "Interpretação por telefone disponível em outros idiomas",
    english: "Inglês",
    spanish: "Espanhol",
    chinese: "Chinês",
    french: "Francês",
    arabic: "Árabe",
    hindi: "Hindu",
    algerian: "Árabe Algeriano",
    russian: "Russo",
    cambodian: 'Cambojano',
    'cambodian (khmer)': 'Cambojano',
    indonesian: 'Indonésio',
    mandarin: 'Mandarim',
    asl: 'Língua de sinais americana (ASL)',
    bengali: 'Bengali',
    bengalis: 'Bengali',
